...
<div class="card mt-3 border bg-body-tertiary rounded-3 animate__animated animate__fadeInDown">
  ...
  <h6 class="fw-bold"><i class="fas fa-folder-open"></i> Data Arsip Laporan PPPS</h6>
  </div>
  <div class="card-body">

    <!-- tombol tambah data arsip laporan -->
    <div class="container text-center">
        <a href="?halaman=divisi_ppps&hal=tambahdatalapppps" class="btn btn-info mt-2 mb-3"><i class="fas fa-copy"></i> Tambah Data</a>
        <a href="modules\arsip_laporan\divisi_ppps\cetak_ppps.php" class="btn btn-warning mt-2 mb-3"><i class="fas fa-print"></i> Cetak Data Arsip</a>
    ...
    <table class="table table-bordered table-hover shadow">
        ...
        <?php
            ...
            $tampil =mysqli_query($koneksi, "SELECT 
                     ...
                     WHERE
                        ...
                        and tbl_laporan.id_pengawas = tbl_pengawas.id_pengawas and tbl_divisi.id_divisi=3;
        ...
        <tr>
            ...
            <td class="text-center">
                <a href="?halaman=divisi_ppps&hal=editlapppps&id=<?=$data['id_lap']?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                <a href="?halaman=divisi_ppps&hal=hapuslapppps&id=<?=$data['id_lap']?>" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini?')"><i class="fas fa-trash"></i></a>
            </td>
        </tr>
    <?php endwhile; ?>
    </table>
