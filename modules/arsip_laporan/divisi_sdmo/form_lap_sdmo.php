...
<div class="card mt-3 border bg-body-tertiary rounded-3 animate__animated animate__fadeInDown">
  ...
  <h6 class="fw-bold"><i class="fas fa-cloud-upload-alt"></i> Form Data Laporan Divisi SDMO</h6>
  </div>
  <div class="card-body">
    ...
    <div class="form-group mt-2">
        ...
        <a href="?halaman=divisi_sdmo" class="btn btn-danger mt-4"><i class="fas fa-reply-all"></i> Batal</a>
    </form>
  </div>
</div>
