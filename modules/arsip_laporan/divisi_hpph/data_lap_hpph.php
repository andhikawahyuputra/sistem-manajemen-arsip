...
<div class="card mt-3 border bg-body-tertiary rounded-3 animate__animated animate__fadeInDown">
  ...
  <h6 class="fw-bold"><i class="fas fa-folder-open"></i> Data Arsip Laporan Divisi HPPH</h6>
  </div>
  <div class="card-body">

    <!-- tombol tambah data arsip laporan -->
    <div class="container text-center">
        <a href="?halaman=divisi_hpph&hal=tambahdatalaphpph" class="btn btn-info mt-2 mb-3"><i class="fas fa-copy"></i> Tambah Data</a>
        <a href="modules\arsip_laporan\divisi_hpph\cetak_hpph.php" class="btn btn-warning mt-2 mb-3"><i class="fas fa-print"></i> Cetak Data Arsip</a>
    ...
    <table class="table table-bordered table-hover shadow">
        ...
        <tr>
            ...
            <td class="text-center">
                <a href="?halaman=divisi_hpph&hal=editlaphpph&id=<?=$data['id_lap']?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                <a href="?halaman=divisi_hpph&hal=hapuslaphpph&id=<?=$data['id_lap']?>" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini?')"><i class="fas fa-trash"></i></a>
            </td>
        </tr>
    <?php endwhile; ?>
    </table>
